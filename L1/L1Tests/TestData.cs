...
namespace L1.Tests
{
    public class TestData
    {
            ...
            public static User user1 = new User("Sepehr Hashemi", "9643", "+981111111111");
            public static User user2 = new User("Reza Mousavi", "3312", "+981111111112");
            public static User user3 = new User("Ali Amadi", "9856", "+981111111113");
            public static User user4 = new User("Mohammad Alavi", "4065", "+981111111114");
            public static User user5 = new User("Kazem Ghalamchi", "1176", "+981111111115");
            public static User user6 = new User("Ahmad Rezaii", "1327", "+981111111116");
            ...
            //Flights
            public static Flight flight1 = new Flight("1144", airline1, 100, "Hamedan", "Mashhad", new DateTime(year: 2019, month: 3, day: 21));
            ...
            public static Flight flight6 = new Flight("9525", airline1, 70, "Shiraz", "Tehran", new DateTime(year: 2019, month: 5, day: 9));
