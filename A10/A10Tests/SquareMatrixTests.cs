...
namespace A10Tests
{
    ...
    public class SquareMatrixTests
    {
        ...
        public void AddTest()
        {
            ...
            {
                new Vector<int>(2) { 3, 1},
                new Vector<int>(2) { 1, -3},
            };

            var m3 = m1 + m2;

            Assert.AreEqual(new Vector<int>(2) { 4, 3}, m3[0]);
            Assert.AreEqual(new Vector<int>(2) { 3, -4 }, m3[1]);
        }
        ...
        {
            SquareMatrix<int> m1 = new SquareMatrix<int>(10)
            {
                new Vector<int>(10) { 1, 0, 1, 0, 1, 2, 7, 8, 9, 10 },
                new Vector<int>(10) { 1, 0, 1, 0, 1, 2, 7, 8, 9, 10 },
                new Vector<int>(10) { 1, 0, 1, 0, 1, 2, 7, 8, 9, 10 },
                new Vector<int>(10) { 1, 0, 1, 0, 1, 2, 7, 8, 9, 10 },
                new Vector<int>(10) { 1, 0, 1, 0, 1, 2, 7, 8, 9, 10 },
            ...
            Assert.AreEqual(39, m3[0, 0]);
            Assert.AreEqual(0, m3[0, 1]);
            Assert.AreEqual(39, m3[0, 2]);
            Assert.AreEqual(390, m3[1, 9]);
        }
